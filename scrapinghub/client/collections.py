...
class Collections(_Proxy):
    ...
    def iter(self) -> Iterable[CollectionSummary]:
    ...
    def list(self) -> List[CollectionSummary]:
...
class Collection(object):
    ...
    def delete(self, keys: Union[str, Iterable[str]]) -> None:
    ...
    def create_writer(self, start: int = 0, auth=None, size: int = 1000,
                      interval: int = 15, qsize: Optional[int] = None,
                      content_encoding: str = 'identity',
                      maxitemsize: int = 1024 ** 2,
